 ...
 * @class
 * @example
 * const bar = new Horizontal({ ...options })
 */
module.exports = class Horizontal {
    /**
    ...
    build() {
        ...
        const Image = Canvas.createCanvas(500, 50);
        ...
        Context.fillRect(0, 0, (percentage / 100) * Image.width, Image.height);
        ...
        if (this.options.textEnabled === true) {
            ...
            Context.fillText(`${this.current}/${this.max}`, Image.width / 2, Image.height / 2);
        }
