 ...
 * @class
 * @example
 * const bar = new Vertical({ ...options })
 */
module.exports = class Vertical {
    /**
    ...
    build() {
        ...
        const Image = Canvas.createCanvas(50, 500);
        ...
        if (this.options.textEnabled === true) {
            if (percentage < 10) Context.font = "30px Poppins-Bold"
            else if (percentage < 100) Context.font = "25px Poppins-Bold"
            else Context.font = "20px Poppins-Bold";
